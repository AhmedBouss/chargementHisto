...
class ajoutClasseur :
    ...
    def ajoutOnglet_D(self, classeur, feuille):
        ...
        self.feuille.autofilter('B5:BB5')
        self.feuille.hide_gridlines(2)
        self.feuille.set_column(1, 53, 29)
        ...
        self.feuille.write('BA5', 'Numero_FCI_Acces', formatFichier)
        self.feuille.write('BB5', 'Numero_FCI_Fin', formatFichier)
