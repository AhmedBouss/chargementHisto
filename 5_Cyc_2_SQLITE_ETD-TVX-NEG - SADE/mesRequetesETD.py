...
OR \
(ETAT_NEGO <> 'PAS DE SYNDIC' and CRS = '' and NB_EL < 4)"
...
'OuiOuiOuiOuiOuiOuiOuiOuiOuiNon', \
'OuiOuiOuiOuiOuiOuiOuiOuiOuiOui')) \
and code_imb not in (select code_IMB from C where NB_EL < 4 and CRS = '' and ETAT_NEGO <> 'PAS DE SYNDIC'))\
OR \
(ETAT_NEGO = 'PAS DE SYNDIC' and Piquetage || Etudes || Travaux_Lances || DOE not in (\
'NonNonNonNon', 'OuiNonNonNon', 'OuiOuiNonNon', 'OuiOuiOuiNon','OuiOuiOuiOui' ))"
...
select_PN_U = "select code_imb, Adresse, plaque, centre_etude, localite, CODE_SYNDIC, NB_EL, PB, '' FI, PA, PM, '' Typo_PB, '' Date_realisation, 'T' Nature_Code_IMB, '' Code_Pere, '' Nature_Facade, Regroupement_RGT, Escalier, 0 NB_Etages, NB_EL_P, NB_EL_R, Type_Site from C_OK_RGT \
...
select_PR_U = "select code_imb, Adresse, plaque, centre_etude, localite, CODE_SYNDIC, NB_EL, PB, '' FI, PA, PM, '' Typo_PB, '' Date_realisation, 'T' Nature_Code_IMB, '' Code_Pere, '' Nature_Facade, Regroupement_RGT, Escalier, 0 NB_Etages, NB_EL_P, NB_EL_R, Type_Site from C_OK_RGT where Jalon in ('Piquetage', 'BPT')"

select_ET_U = "select code_imb, Adresse, plaque, centre_etude, localite, CODE_SYNDIC, NB_EL, PB, '' FI, PA, PM, '' Typo_PB, '' Date_realisation, 'T' Nature_Code_IMB, '' Code_Pere, '' Nature_Facade, Regroupement_RGT, Escalier, 0 NB_Etages, NB_EL_P, NB_EL_R, Type_Site, Date_fin_EZA, Resultat_etude_site from C_OK_RGT where Jalon in ('Etude')"

select_TL_U = "select code_imb, Adresse, plaque, centre_etude, localite, CODE_SYNDIC, NB_EL, PB, '' FI, PA, PM, '' Typo_PB, '' Date_realisation, 'T' Nature_Code_IMB, '' Code_Pere, '' Nature_Facade, Regroupement_RGT, Escalier, 0 NB_Etages, NB_EL_P, NB_EL_R, Type_Site, Date_fin_EZA, Resultat_etude_site, FCI_ACCES from C_OK_RGT where Jalon in ('Travaux lancés') and Date_prog_racco <> ''"

select_TR_U = "select code_imb, Adresse, plaque, centre_travaux, '' CDT, localite, NB_EL, PB, PA_INI, PM, '' Date_realisation, 'Interne' Prod_int_presta, '' Entreprise, FCI_ACCES, date_pose_pb from C_OK_RGT where Jalon in ('DOE') and date_pose_pb <> ''"

select_DO_U = "select code_imb, Adresse, plaque, centre_etude, localite, CODE_SYNDIC, NB_EL, PB, '' FI, PA, PM, \
     '' Typo_PB, '' Date_realisation, 'T' Nature_Code_IMB, '' Code_Pere, '' Nature_Facade, Regroupement_RGT, \
...
updateEtudes = "update C set Etudes = 'Oui' where (Etat_Nego <> 'PAS DE SYNDIC' and Resultat_etude_site = 'OK' and Type_Site <> '' and NB_EL_P <> '' and NB_EL_R <> '') OR (Etat_Nego = 'PAS DE SYNDIC' and Resultat_etude_site = 'OK' and Type_Site <> '' and NB_EL_P <> '' and NB_EL_R <> '')" 
